...
extension UIColor {
    ...
    static let c292929 = UIColor(named: "292929", in: Bundle(for: UrpayCardsSDK.self), compatibleWith: nil)!
    
    static let c232526 = UIColor(named: "232526", in: Bundle(for: UrpayCardsSDK.self), compatibleWith: nil)!
    
    static let c151515 = UIColor(named: "151515", in: Bundle(for: UrpayCardsSDK.self), compatibleWith: nil)!
    
    static let c7D7D80 = UIColor(named: "7D7D80", in: Bundle(for: UrpayCardsSDK.self), compatibleWith: nil)!
    
    static let c24282D = UIColor(named: "24282D", in: Bundle(for: UrpayCardsSDK.self), compatibleWith: nil)!
    
    static let cAE926A = UIColor(named: "AE926A", in: Bundle(for: UrpayCardsSDK.self), compatibleWith: nil)!
