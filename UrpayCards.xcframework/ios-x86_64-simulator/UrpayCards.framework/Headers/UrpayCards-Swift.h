...
#ifndef URPAYCARDS_SWIFT_H
#define URPAYCARDS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UrpayCards",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10UrpayCards18BaseViewController")
...
@interface BaseViewController (SWIFT_EXTENSION(UrpayCards)) <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC10UrpayCards20NavigationController")
...
@property (nonatomic) IBInspectable BOOL isCircled;
